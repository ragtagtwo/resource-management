...
} from "./chunk-YAS3RL6C.js";
import {
  DOCUMENT,
  Location
} from "./chunk-SZYUVCFQ.js";
import {
...
var MatSnackBarRef = class {
  constructor(containerInstance, _overlayRef) {
    ...
    this._afterDismissed = new import_rxjs4.Subject();
    this._afterOpened = new import_rxjs4.Subject();
    this._onAction = new import_rxjs4.Subject();
...
var _MatSnackBarContainer = class _MatSnackBarContainer extends BasePortalOutlet {
  constructor(_ngZone, _elementRef, _changeDetectorRef, _platform, snackBarConfig) {
    ...
    this._onAnnounce = new import_rxjs4.Subject();
    this._onExit = new import_rxjs4.Subject();
    this._onEnter = new import_rxjs4.Subject();
...
var _MatSnackBar = class _MatSnackBar {
  ...
  _attach(content, userConfig) {
    ...
    this._breakpointObserver.observe(Breakpoints.HandsetPortrait).pipe((0, import_operators3.takeUntil)(overlayRef.detachments())).subscribe((state2) => {
